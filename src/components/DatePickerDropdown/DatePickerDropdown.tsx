...
const DatePickerDropdown = <T extends FieldValues>({
  ...
  const startDate = startDateValue && (dayjs.isDayjs(startDateValue) ? startDateValue : dayjs(startDateValue));
  const endDate = endDateValue && (dayjs.isDayjs(endDateValue) ? endDateValue : dayjs(endDateValue));
